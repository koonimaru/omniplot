...
import igraph
from .igraph_classes import MatplotlibGraphDrawer
import numpy as np
...
sns.set_theme()
def pienodes(g,vertex_label=[], node_features={}, pie_frac="frac",pie_label="label",pie_palette="tab20b", **kwargs):
    ...
    for i, n in enumerate(nodes):
        ...
        a = plt.axes([xa-deg[i]/2,ya-deg[i]/2, deg[i], deg[i]], zorder=0,rasterized=True,adjustable="datalim")
        #a.set_zorder(1)
        a.set_aspect('equal')
